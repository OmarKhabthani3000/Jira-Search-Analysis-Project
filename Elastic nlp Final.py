...
def search_issues_with_sbert_embedding(query_summary, query_description, project_key=None, issue_type=None, num_results=5):
...
search_issues_with_sbert_embedding(query_summary, query_description, project_key, issue_type)
