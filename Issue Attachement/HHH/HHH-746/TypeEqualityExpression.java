...
public class TypeEqualityExpression extends SimpleExpression {
	...
	throws HibernateException {
		...
		return new TypedValue[] {
				fixDiscriminatorTypeValue(
						criteriaQuery.getTypedValue(criteria, classPropertyName, classValue) )
		};
	...
	private TypedValue fixDiscriminatorTypeValue(TypedValue typedValue) {
		...
		if(!String.class.isInstance(value) ||
		   !typedValue.equals(
				   new TypedValue(typedValue.getType(), typedValue.getValue(), EntityMode.POJO)))
