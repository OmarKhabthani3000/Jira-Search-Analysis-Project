...
public class QueryPlanCache implements Serializable {
	...
	/**
	 * Constructs a new query plan cache for the given factory.
	...
	public QueryPlanCache(SessionFactoryImplementor factory) {
		...
		int maxStrongReferences = (maxStrongReferencesProperty != null) ?
				Integer.valueOf(maxStrongReferencesProperty) : SoftLimitMRUCache.DEFAULT_STRONG_REF_COUNT;

		String maxSoftReferencesProperty = properties.getProperty(
				Environment.QUERY_PLAN_CACHE_MAX_SOFT_REFERENCES);
		int maxSoftReferences = (maxSoftReferencesProperty != null) ?
				Integer.valueOf(maxSoftReferencesProperty) : SoftLimitMRUCache.DEFAULT_SOFT_REF_COUNT;
	...
	/**
	 * Gets the SQL parameter metadata for the given query.
	 * @param query a query.
	 * @return the SQL parameter metadata.
	 */
	...
	/**
	 * Gets the HQL query plan for the given parameters.
	 * @param queryString
	 * @param shallow
	 * @param enabledFilters
	 * @return the HQL query plan.
	...
	/**
	 * Gets the filter query plan for the given parameters.
	 * @param filterString
	 * @param collectionRole
	 * @param shallow
	 * @param enabledFilters
	 * @return the filter query plan.
	 * @throws QueryException
	 * @throws MappingException
	 */
	...
	/**
	 * Gets the native SQL query plan for the given parameters.
	 * @param spec
	 * @return the native SQL query plan.
	 */
