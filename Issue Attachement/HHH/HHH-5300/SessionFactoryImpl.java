...
public final class SessionFactoryImpl implements SessionFactory, SessionFactoryImplementor {
	...
	/**
	 * Constructs a session factory with the given parameters.
	 * @param cfg
	 * @param mapping
	 * @param settings
	 * @param listeners
	...
	/**
	 * Registers the entity name resolver.
	 * @param resolver
	 * @param entityMode
	 */
	...
	/**
	 * Iterates the entity name resolvers.
	 * @param entityMode
	 * @return the iterator.
	 */
	...
	/**
	 * Gets the batcher factory.
	 * @return the batcher factory.
	 */
