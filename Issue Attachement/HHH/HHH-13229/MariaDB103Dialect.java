...
public class MariaDB103Dialect extends MariaDB102Dialect {
	...
	public String getQuerySequencesString() {
		...
		//TODO: Its possible to get schema and catalog to from this query. If several databases exist 
	}

	@Override
	public SequenceInformationExtractor getSequenceInformationExtractor() {
		//TODO: Future improvement - https://hibernate.atlassian.net/browse/HHH-13008
		// New SequenceNameExtractor for Maria DB
		return SequenceNameExtractorMariaDBImpl.INSTANCE;
	}
