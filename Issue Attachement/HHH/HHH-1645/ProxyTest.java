//$Id: ProxyTest.java 10976 2006-12-12 23:22:26Z steve.ebersole@jboss.com $
...
//		System.out.println( "Average size : " + ( cumulativeSize / iterations ) + " bytes" );
	...
	public void testRefreshLockInitializedProxy() {
		...
		s.refresh(dp, LockMode.UPGRADE);
		assertEquals(LockMode.UPGRADE, s.getCurrentLockMode(dp));
