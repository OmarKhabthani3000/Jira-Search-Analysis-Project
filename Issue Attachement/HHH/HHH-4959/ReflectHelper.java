/*
 * Modified org.hibernate.util.ReflectHelper that avoids calling loadClass for known missing classes.
 * New code is in classForName() and classForNameInternal().
 */
...
public final class ReflectHelper {
	...
	public static Class classForName(String name, Class caller) throws ClassNotFoundException {
        String key = name + "-" + (caller == null ? "null" : caller.getName());
        Object classOrException = classes.get(key);
        if (classOrException == null) {
            classOrException = classForNameInternal(name, caller);
            classes.put(key, classOrException);
        }
        if (classOrException instanceof ClassNotFoundException) {
          throw (ClassNotFoundException) classOrException;
        }
        return (Class) classOrException;
	}
    ...
    private static Object classForNameInternal(String name, Class caller) {
        try {
