//$Id: Table.java,v 1.27 2005/02/14 10:59:35 maxcsaucdk Exp $
...
public class Table implements RelationalModel, Serializable {
	...
	public String sqlCreateString(Dialect dialect, Mapping p, String defaultCatalog, String defaultSchema) throws HibernateException {
		...
		boolean identityColumn = getIdValue() != null &&
				getIdValue().createIdentifierGenerator(dialect, defaultCatalog, defaultSchema, null) instanceof IdentityGenerator;

		// Try to find out the name of the primary key to create it as identity if the IdentityGenerator is used
		String pkname = null;
		if ( getPrimaryKey() != null && identityColumn ) {
