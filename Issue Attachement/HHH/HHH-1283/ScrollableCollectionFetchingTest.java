// $Id: ScrollableCollectionFetchingTest.java,v 1.3 2005/12/19 20:59:57 steveebersole Exp $
...
//                .createQuery( "from Animal a where a.description like :desc order by a.id" )
	...
	private void checkResult(Animal animal) {
		if ( "root-1".equals( animal.getDescription() ) ) {
			...
			assertEquals( "root-2 did not contain both children", 2, animal.getOffspring().size() );
		}
	}
	...
	private class TestData {
		...
		private void prepare() {
            ...
            Animal son2 = new Animal();
            son2.setDescription( "son2");
            Animal daughter2 = new Animal();
            daughter2.setDescription( "daughter2" );

            son2.setMother( another );
            another.addOffspring( son2 );
            daughter2.setMother( another );
            another.addOffspring( daughter2 );
