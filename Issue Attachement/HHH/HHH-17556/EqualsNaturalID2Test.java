...
@DomainModel(
        annotatedClasses = {
                EqualsNaturalID2Test.State.class,
                EqualsNaturalID2Test.Citizen.class,
                EqualsNaturalID2Test.NaturalIdOnManyToOne.class,
        }
)

@SessionFactory
public class EqualsNaturalID2Test {
    ...
    public static class Citizen {
        ...
        public boolean equals(Object o) {
            ...
            if (getState() != null ? !getState().equals(citizen.getState()) : citizen.getState() != null) return false;
            return getSsn() != null ? getSsn().equals(citizen.getSsn()) : citizen.getSsn() == null;
        }
    ...
    public static class NaturalIdOnManyToOne {
        ...
        public boolean equals(Object o) {
            if (this == o) return true;
            if (!(o instanceof NaturalIdOnManyToOne that)) return false;
            if (getCitizen() != null ? !getCitizen().equals(that.getCitizen()) : that.getCitizen() != null)
                return false;
        ...
        @Override
        public int hashCode() {
            int result = getCitizen() != null ? getCitizen().hashCode() : 0;
