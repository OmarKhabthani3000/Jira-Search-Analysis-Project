...
public class SAPDBDialect extends Dialect {
	...
	/* **START** Adding suport for identity columns 
		by Agustin Ane 2006-12-29
	*/
	...
	public String getIdentityColumnString(int type) throws MappingException {
		return type==Types.BIGINT ?
		 	"fixed(19,0) not null default serial(1)" :
		 	"int not null default serial(1)";
	}
	/* **END** Adding suport for identity columns */
