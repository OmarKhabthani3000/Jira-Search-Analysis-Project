...
public class BasicSet extends AbstractEntityTest {
    ...
    public void initData() {
        ...
        SetOwnedEntity ed3 = new SetOwnedEntity(3, "data_ed_3");
    ...
    public void testRevisionsCounts() {
        ...
        assert Arrays.asList(1, 2, 3, 4, 5, 6).equals(getAuditReader().getRevisions(SetOwningEntity.class, ing1_id));
    ...
    public void testHistoryOfEdId1() {
        ...
        SetOwnedEntity rev6 = getAuditReader().find(SetOwnedEntity.class, ed1_id, 6);
        ...
        assert rev6.getReferencing().equals(TestTools.makeSet(ing2));
    }
    ...
    public void testHistoryOfEdId2() {
        ...
        SetOwnedEntity rev6 = getAuditReader().find(SetOwnedEntity.class, ed2_id, 5);
    ...
    @Test
    public void testHistoryOfEdId3() {
        SetOwningEntity ing1 = getEntityManager().find(SetOwningEntity.class, ing1_id);

        SetOwnedEntity rev1 = getAuditReader().find(SetOwnedEntity.class, ed3_id, 1);
        SetOwnedEntity rev2 = getAuditReader().find(SetOwnedEntity.class, ed3_id, 2);
        SetOwnedEntity rev3 = getAuditReader().find(SetOwnedEntity.class, ed3_id, 3);
        SetOwnedEntity rev4 = getAuditReader().find(SetOwnedEntity.class, ed3_id, 4);
        SetOwnedEntity rev5 = getAuditReader().find(SetOwnedEntity.class, ed3_id, 5);
        SetOwnedEntity rev6 = getAuditReader().find(SetOwnedEntity.class, ed3_id, 5);

        assert rev1.getReferencing().equals(Collections.EMPTY_SET);
        assert rev2.getReferencing().equals(Collections.EMPTY_SET);
        assert rev3.getReferencing().equals(Collections.EMPTY_SET);
        assert rev4.getReferencing().equals(Collections.EMPTY_SET);
        assert rev5.getReferencing().equals(TestTools.makeSet(ing1));
        assert rev6.getReferencing().equals(Collections.EMPTY_SET);
    }
    ...
    public void testHistoryOfEdIng1() {
        ...
        SetOwnedEntity ed3 = getEntityManager().find(SetOwnedEntity.class, ed3_id);
        ...
        SetOwningEntity rev6 = getAuditReader().find(SetOwningEntity.class, ing1_id, 6);
        ...
        assert rev5.getReferences().equals(TestTools.makeSet(ed3));
        assert rev6.getReferences().equals(Collections.EMPTY_SET);
    }
    ...
    public void testHistoryOfEdIng2() {
        ...
        SetOwningEntity rev6 = getAuditReader().find(SetOwningEntity.class, ing2_id, 6);

        assert rev1.getReferences().equals(Collections.EMPTY_SET);
        assert rev2.getReferences().equals(TestTools.makeSet(ed1, ed2));
        assert rev3.getReferences().equals(TestTools.makeSet(ed1, ed2));
        assert rev4.getReferences().equals(TestTools.makeSet(ed1, ed2));
        assert rev5.getReferences().equals(TestTools.makeSet(ed2));
        assert rev6.getReferences().equals(TestTools.makeSet(ed2));
    }
}