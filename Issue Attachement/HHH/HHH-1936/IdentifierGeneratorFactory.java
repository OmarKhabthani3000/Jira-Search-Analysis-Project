...
public final class IdentifierGeneratorFactory {
	...
	throws SQLException, IdentifierGenerationException {
		...
		if ( clazz==Long.class ) {
			...
			throw new IdentifierGenerationException("this id generator generates long, integer, short , BigDecimal, BigInteger or string. Missed cast on "+clazz.getName());
		}
	...
	public static Number createNumber(long value, Class clazz) throws IdentifierGenerationException {
			...
			throw new IdentifierGenerationException("this id generator generates long, integer, short, BigDecimal, BigInteger. Missed cast on "+clazz.getName());
		}
	}
