...
public class Example implements Criterion {
    ...
    /** contains the MatchModes/ Property **/
    private Map propertyMatchModes = new HashMap();
    ...
    /**
     * Use the "like" operator for the string-valued property nad the specific MatchMode.
     * Setting a specific one enables the isLikeEnable.
     **/
    public Example enableLike(String property, MatchMode matchMode) {
        
        // define the specific one.                 
        isLikeEnabled = true;
        propertyMatchModes.put(property, matchMode);
        return this;
    }
            ...
            if ( value instanceof String ) {
                ...
                if (isLikeEnabled) {
                     if (type instanceof EntityType) {
                        ...
                        String propertyName = entityType.getPropertyName();  
                        string = toMatchString(string, propertyName);                        
                    }
                }
    ...
    /**
     * @param string the String to convert to the MatchMode
     * @param propertyName the name of the property 
     * @return the matchString
     */
    protected String toMatchString(String string, String propertyName) {
        String matchString = null;
        
        MatchMode matchMode = (MatchMode)propertyMatchModes.get(propertyName);
        if (matchMode == null && this.matchMode != null){
            matchMode = this.matchMode;
        } else {
            matchMode = matchMode.EXACT;
        }
        
        matchString = matchMode.toMatchString(string);
