...
public class ProviderMBeanRegistrationHelperTest {
	...
	public void testJMXRegistration() throws Exception {
		...
		try {
	        ...
	        TimerTask instance = configureTimeTask(ehcacheHibernateMBeanRegistration);
	...
	private TimerTask configureTimeTask(EhcacheHibernateMBeanRegistrationImpl ehcacheHibernateMBeanRegistration) throws Exception {
		...
		for (Class<?> clazz : classes) {
			if ("org.hibernate.cache.ehcache.management.impl.ProviderMBeanRegistrationHelper.RegisterMBeansTask".equals(clazz.getCanonicalName())) {
				...
				instance = (TimerTask) constructor.newInstance(ehcacheHibernateMBeanRegistration, manager, new Properties());
			}
