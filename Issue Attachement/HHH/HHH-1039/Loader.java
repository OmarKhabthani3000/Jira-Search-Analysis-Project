...
// that I could do the control breaking at the means to know when to stop
        ...
        for (int i = 0; i < cols; i++) {
            ...
            if (keys[i] == null) {
                ...
                if (object != null) {
                    ...
                    try {
                    ...
                    } catch (WrongClassException wce) {
                        System.out.println("Special Hibernate Fix: Wrong ClassExecption: attempting reload...");
                        ...
                        System.out.println("Reload complete with object:"+(object==null?"null":object.getClass()));
                    }
                } else {
                    object = instanceNotYetLoaded(
                            rs,
    ...
    private void instanceAlreadyLoaded(
        ...
        if (!persister.isInstance(object, session.getEntityMode())) {
            System.out.println("Hibernate WrongClassException: id: "+key.getIdentifier()+",ent: "+persister.getEntityName());
