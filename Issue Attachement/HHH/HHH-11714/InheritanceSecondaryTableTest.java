...
public class InheritanceSecondaryTableTest extends BaseEntityManagerFunctionalTestCase {
	@Override
	...
	@Test
	public void testInheritanceWithSecondaryTable1() {
	...
	@Test
	public void testInheritanceWithSecondaryTable2() {
		doInJPA( this::entityManagerFactory, entityManager -> {
			final TopLevelEntity top = new TopLevelEntity();
			...
			final GeographicArea area1 = new GeographicArea();
			area1.setTopLevel( top );
			area1.setShape( circle );
			top.getGeographicAreas().add( area1 );

			final GeographicArea area2 = new GeographicArea();
			area2.setTopLevel( top );
			area2.setShape( new ShapePolygonEntity() );
			top.getGeographicAreas().add( area2 );
