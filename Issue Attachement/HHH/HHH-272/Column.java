//$Id: Column.java,v 1.13 2005/02/12 07:19:26 steveebersole Exp $
...
public class Column implements Selectable, Serializable {
	...
	public static final int DEFAULT_SCALE = 19;
	
	private int length=DEFAULT_LENGTH;
	private int precision=DEFAULT_SCALE;
	private Value value;
	...
	public String getSqlType(Dialect dialect, Mapping mapping) throws HibernateException {
		return sqlType==null ?
			dialect.getTypeName( getSqlTypeCode(mapping), getLength(), getPrecision() ) :
			sqlType;
	}
