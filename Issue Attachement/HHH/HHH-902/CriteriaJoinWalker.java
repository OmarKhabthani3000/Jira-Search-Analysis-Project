...
public class CriteriaJoinWalker extends AbstractEntityJoinWalker {
    ...
    private String afterTableString;
	...
	throws HibernateException {
        ...
        setAfterTableString(criteria.getAfterTableSql());
	...
	protected String fromAfterTableFragment() {
		return afterTableString == null ? 
			"" : 
			" " + afterTableString;
	}

	protected void setAfterTableString(String string) {
		afterTableString = string;
	}
}
