//$Id: SelectParser.java,v 1.2 2004/08/10 05:06:11 oneovthafew Exp $
	...
	public void token(String token, QueryTranslatorImpl q) throws QueryException {
		...
		if (afterNew) {
			...
			if (insideNew && !aggregate && !ready) {
				...
				insideNew = q.finalizeActualHolderClass();
			}
			...
			if (insideNew)
			    q.addScalarIndexInHolderClass(scalarCount++);
