...
public class VersionsEventListener implements PostInsertEventListener, PostUpdateEventListener,
    ...
    private void generateBidirectionalCollectionChangeWorkUnits(VersionsSync verSync, EntityPersister entityPersister,
                                                                String entityName, Object[] newState, Object[] oldState, SessionImplementor session) {
    ...
    public void onPostInsert(PostInsertEvent event) {
        ...
        if (verCfg.getEntCfg().isVersioned(entityName)) {
            ...
            generateBidirectionalCollectionChangeWorkUnits(verSync, event.getPersister(), entityName, event.getState(), null, event.getSession());
        }
    }
    ...
    public void onPostUpdate(PostUpdateEvent event) {
        ...
        if (verCfg.getEntCfg().isVersioned(entityName)) {
            ...
            generateBidirectionalCollectionChangeWorkUnits(verSync, event.getPersister(), entityName, event.getState(), event.getOldState(), event.getSession());
        }
    }
    ...
    public void onPostDelete(PostDeleteEvent event) {
        ...
        if (verCfg.getEntCfg().isVersioned(entityName)) {
            ...
            generateBidirectionalCollectionChangeWorkUnits(verSync, event.getPersister(), entityName, null, event.getDeletedState(), event.getSession());
        }
    }
