...
public abstract class ExternalSessionFactoryConfig {
	...
	protected final Configuration buildConfiguration() {
		...
		if (getMappedClasses() == null || "".equals(getMappedClasses())) {
			return ConfigurationFactory.getStandardConfiguration(this);
		} else {
			return ConfigurationFactory.getAnnotationConfiguration(this);
		}
	}
