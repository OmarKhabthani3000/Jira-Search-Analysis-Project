...
public class CriteriaImpl implements Criteria, Serializable {
  ...
  public CriteriaImpl(String entityOrClassName, boolean isClass, SessionImplementor session) {
    this(entityOrClassName, isClass, ROOT_ALIAS, session);
  }

  public CriteriaImpl(String entityOrClassName, boolean isClass, String alias, SessionImplementor session) {
