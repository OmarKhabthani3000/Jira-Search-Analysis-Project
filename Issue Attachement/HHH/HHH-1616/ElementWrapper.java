...
public class ElementWrapper implements Element, Serializable {
	...
	public String getPath(Element element) {
		return this.element.getPath( element ); // JHS 28-Mar-06 Scoping error, added "this."
	}
	...
	public String getUniquePath(Element element) {
		return this.element.getUniquePath( element ); // JHS 28-Mar-06 Scoping error, added "this."
	}
	...
	public Node asXPathResult(Element element) {
		return this.element.asXPathResult( element ); // JHS 28-Mar-06 Scoping error, added "this."
	}
	...
	public void appendAttributes(Element element) {
		this.element.appendAttributes( element ); // JHS 28-Mar-06 Scoping error, added "this."
	}
	...
	public void add(Element element) {
		this.element.add( element ); // JHS 28-Mar-06 Scoping error, added "this."
	}
	...
	public boolean remove(Element element) {
		return this.element.remove( element ); // JHS 28-Mar-06 Scoping error, added "this."
	}
