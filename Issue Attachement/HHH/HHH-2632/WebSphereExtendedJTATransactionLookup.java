//$Id: WebSphereExtendedJTATransactionLookup.java,v 1.1.1.2 2007/04/18 19:14:50 rosec Exp $
package com.aciworldwide.ecourier.utility.hibernate.extensions;
...
public class WebSphereExtendedJTATransactionLookup implements TransactionManagerLookup {
        ...
        public static class TransactionManagerAdapter implements TransactionManager {
                ...
                /**
                 * This class differs from the class in Hibernate in that it only looks up JNDI resources
                 * at need, which means that methods that take place outside of the context of the
                 * application server transactions won't cause problems.
                 */
                public class TransactionAdapter implements Transaction {
                        ...
                        private Object getExtendedJTATransaction () {
                            if (extendedJTATransaction == null) {
                                try {
                                    extendedJTATransaction = NamingHelper.getInitialContext(contextProperties)
                        ...
                        private Object getLocalId() {
                                try {
                                        return getLocalIdMethod.invoke(getExtendedJTATransaction (), null);
                                }
                                catch (Exception e) {
                                        throw new HibernateException(e);
                                }
