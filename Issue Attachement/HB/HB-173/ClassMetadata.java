//$Id: ClassMetadata.java,v 1.6.2.2 2003/09/02 11:31:33 oneovthafew Exp $
...
public interface ClassMetadata {
	 ...
	 * Get the Hibernate types of the class properties
	 */
	public Map[] getPropertyMetaValues();
	
	/**
	 * Get the type of a particular (named) property
	 */
	public Map getPropertyMetaValues(String propertyName) throws HibernateException;	
	
	/**
	 * Get the Hibernate length of the class properties
	 */
	public int[] getPropertyLengths();
	
	/**
	 * Get the length of a particular (named) property
	 */
	public int getPropertyLength(String propertyName) throws HibernateException;
