...
public class SpatialSearchSortByDistanceAndPaging extends SearchTestCase {
    ...
    public void testSortWithPageSize5_notOk() {
        Assert.assertEquals("sorting by distance and paging error",
    ...
    public int doSearch(double distance, int pageSize, boolean sortByDistance) {
        ...
        System.out.println(String.format("distance %.2f pageSize %d, sortByDistance %s",
    ...
    private void printResults(List<GeoEntity> list) {
        ...
        for (GeoEntity entity : list) {
            ...
            System.out.println(String.format("%d %f %d%s",
     ...
     */
    private List distanceSearch(double startLat,
            double startLon,
            double distance,
            int firstResult,
            int maxResult,
        ...
        try {
            ...
            if (sortByDistance) {
                ...
                Sort distanceSort = new Sort(
                        new DistanceSortField(startLat,
                        startLon,
