...
public class DocumentBuilderIndexedEntity extends AbstractDocumentBuilder {
	...
	private void addFacetDocValues(Document document,
		...
		if ( value instanceof Collection ) {
			for (String v : (Collection<String>)value) {
				field = getFacetDocValues(document, fieldMetadata, facetMetadata, v);
			...
			field = getFacetDocValues(document, fieldMetadata, facetMetadata, value);
	...
	private Field getFacetDocValues(Document document,
			DocumentFieldMetadata fieldMetadata,
			FacetMetadata facetMetadata,
			Object value) {
		// we don't add null values to the facet field
	...
	/**
	 * Adds the doc field values to the document required to map the con value from the
