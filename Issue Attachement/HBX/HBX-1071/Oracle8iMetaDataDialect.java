 ...
 * @author mmullally
 */
public class Oracle8iMetaDataDialect extends AbstractMetaDataDialect
{

    public Oracle8iMetaDataDialect()
    {
        super();
    }
    /* ******* TABLE QUERIES ******* */
//    private static final String SQL_TABLE_BASE =
//        "select  a.table_name, a.owner, b.comments, 'TABLE' " + "from all_tables a left join all_tab_comments b " + "on (a.owner=b.owner and a.table_name=b.table_name) ";
    private static final String SQL_TABLE_BASE =
        "select a.table_name, a.owner, b.comments, 'TABLE' " + "from all_tables a, all_tab_comments b " + "where a.owner=b.owner (+) and a.table_name=b.table_name (+) ";
    ...
    private static final String SQL_TABLE_SCHEMA = SQL_TABLE_BASE + "and a.owner = ? " + SQL_TABLE_VIEW + " where owner = ?";
    private static final String SQL_TABLE_TABLE = SQL_TABLE_BASE + "and a.table_name = ?" + SQL_TABLE_VIEW + "where view_name = ?";
    private static final String SQL_TABLE_SCHEMA_AND_TABLE = SQL_TABLE_BASE + "and a.owner = ? and a.table_name = ?" + SQL_TABLE_VIEW + "where owner = ? and view_name = ?";
//    private static final String SQL_TABLE_SCHEMA = SQL_TABLE_BASE + "where a.owner = ? " + SQL_TABLE_VIEW + " where owner = ?";
//    private static final String SQL_TABLE_TABLE = SQL_TABLE_BASE + "where a.table_name = ?" + SQL_TABLE_VIEW + "where view_name = ?";
//    private static final String SQL_TABLE_SCHEMA_AND_TABLE = SQL_TABLE_BASE + "where a.owner = ? and a.table_name = ?" + SQL_TABLE_VIEW + "where owner = ? and view_name = ?";
    ...
    private static final String SQL_INDEX_SCHEMA_AND_TABLE = SQL_INDEX_BASE + "where a.table_owner = ? and a.table_name = ? " + SQL_INDEX_ORDER;
    ...
    private static final String SQL_COLUMN_SCHEMA_AND_TABLE = SQL_COLUMN_BASE + "where a.owner = ? and a.table_name = ? " + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_SCHEMA_AND_COLUMN = SQL_COLUMN_BASE + "where a.owner = ? and a.column_name = ? " + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_TABLE_AND_COLUMN = SQL_COLUMN_BASE + "where a.table_name = ? and a.column_name = ? " + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_SCHEMA_AND_TABLE_AND_COLUMN = SQL_COLUMN_BASE + "where a.owner = ? and a.table_name = ? and a.column_name = ? " + SQL_COLUMN_ORDER;
    */
    
    private static final String SQL_COLUMN_BASE = "select a.column_name as COLUMN_NAME, a.owner as TABLE_SCHEM, " + "decode(a.nullable,'N',0,1) as NULLABLE, " + "decode(a.data_type, 'FLOAT',decode(a.data_precision,null, " + "a.data_length, a.data_precision), 'NUMBER', decode(a.data_precision,null, " + "a.data_length, a.data_precision), a.data_length) as COLUMN_SIZE, " + "decode(a.data_type,'CHAR',1, 'DATE',91, 'FLOAT',6, " + "'LONG',-1, 'NUMBER',2, 'VARCHAR2',12, 'BFILE',-13, " + "'BLOB',2004, 'CLOB',2005, 'MLSLABEL',1111, 'NCHAR',1, 'NCLOB',2005, 'NVARCHAR2',12, " + "'RAW',-3, 'ROWID',1111, 'UROWID',1111, 'LONG RAW', -4, " + "'TIMESTAMP', 93, 'XMLTYPE',2005, 1111) as DATA_TYPE, " + "a.table_name as TABLE_NAME, a.data_type as TYPE_NAME, " + "decode(a.data_scale, null, 0 ,a.data_scale) as DECIMAL_DIGITS, b.comments "
            + "from all_tab_columns a, all_col_comments b where " + "a.owner=b.owner (+) and a.table_name=b.table_name (+) and a.column_name=b.column_name (+) ";
    private static final String SQL_COLUMN_ORDER = " order by column_id ";
    private static final String SQL_COLUMN_NONE = SQL_COLUMN_BASE + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_SCHEMA = SQL_COLUMN_BASE + "and a.owner = ? " + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_TABLE = SQL_COLUMN_BASE + "and a.table_name = ? " + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_COLUMN = SQL_COLUMN_BASE + "and a.column_name = ? " + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_SCHEMA_AND_TABLE = SQL_COLUMN_BASE + "and a.owner = ? and a.table_name = ? " + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_SCHEMA_AND_COLUMN = SQL_COLUMN_BASE + "and a.owner = ? and a.column_name = ? " + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_TABLE_AND_COLUMN = SQL_COLUMN_BASE + "and a.table_name = ? and a.column_name = ? " + SQL_COLUMN_ORDER;
    private static final String SQL_COLUMN_SCHEMA_AND_TABLE_AND_COLUMN = SQL_COLUMN_BASE + "and a.owner = ? and a.table_name = ? and a.column_name = ? " + SQL_COLUMN_ORDER;
    ...
    private static final String SQL_PK_SCHEMA_AND_TABLE = SQL_PK_BASE + " and c.owner = ? and c.table_name = ? " + SQL_PK_ORDER;
    */
    private static final String SQL_PK_BASE = "select c.table_name, c.column_name, c.position,  c.constraint_name, c.owner "
            + "from all_cons_columns c, all_constraints k where " + "k.owner (+) = c.owner AND k.table_name (+) = c.table_name AND k.constraint_name (+) = c.constraint_name AND " + "k.constraint_type (+) = 'P' ";
    private static final String SQL_PK_ORDER = " order by c.table_name, c.constraint_name, c.position desc ";
    private static final String SQL_PK_NONE = SQL_PK_BASE + SQL_PK_ORDER;
    private static final String SQL_PK_SCHEMA = SQL_PK_BASE + " and c.owner = ? " + SQL_PK_ORDER;
    private static final String SQL_PK_TABLE = SQL_PK_BASE + " and c.table_name = ? " + SQL_PK_ORDER;
    ...
    private static final String SQL_FK_SCHEMA_AND_TABLE = SQL_FK_BASE + " and p.owner = ? and p.table_name = ? " + SQL_FK_ORDER;
                ...
                getSQLExceptionConverter())
            {
                ...
                protected Throwable handleSQLException(SQLException e)
                {
                    ...
                    throw getSQLExceptionConverter().convert(
                        e,
                        "Could not get list of tables from database. Probably a JDBC driver problem. " + databaseStructure, null);
                }
            };
